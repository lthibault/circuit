...
<pre>
	$GOPATH/github.com/lthibault/circuit/tutorial/nodejs-using-mysql/start-app/main.go
</pre>
...
<p>Notable here is the import of the circuit client package <code>"github.com/lthibault/circuit/client"</code>
